  ...
  crates = {
    ...
    "assert-json-diff 1.0.0 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          "serde" = "serde 1.0.97 (registry+https://github.com/rust-lang/crates.io-index)";
    ...
    "bstr 0.2.2 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        version = "0.2.2";
        edition = "2015";
        sha256 = "1fp0pgbqbgiyr9mjaid28cwwy39bf181y4sbrk195kc8xlc1vmz2";
        authors = [
          "Andrew Gallant <jamslam@gmail.com>"
        ];
        dependencies = {
          ...
          "regex-automata" = {
            packageId = "regex-automata 0.1.7 (registry+https://github.com/rust-lang/crates.io-index)";
            optional = true;
            usesDefaultFeatures = false;
          };
          "serde" = {
            packageId = "serde 1.0.97 (registry+https://github.com/rust-lang/crates.io-index)";
            optional = true;
            usesDefaultFeatures = false;
          };
        };
    ...
    "csv 1.1.1 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          "bstr" = {
            packageId = "bstr 0.2.2 (registry+https://github.com/rust-lang/crates.io-index)";
            features = [ "serde1" ];
          };
    ...
    "hydra-cli 0.2.0 (path+file:///home/gilligan/dev/orange/hydra-cli)"
      = rec {
        ...
        dependencies = {
          ...
          "reqwest" = "reqwest 0.9.18 (registry+https://github.com/rust-lang/crates.io-index)";
          "serde" = "serde 1.0.97 (registry+https://github.com/rust-lang/crates.io-index)";
          "serde_derive" = "serde_derive 1.0.97 (registry+https://github.com/rust-lang/crates.io-index)";
          "serde_json" = "serde_json 1.0.40 (registry+https://github.com/rust-lang/crates.io-index)";
        };
        features = {
        };
    ...
    "hyper-tls 0.3.2 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          "bytes" = "bytes 0.4.12 (registry+https://github.com/rust-lang/crates.io-index)";
          "futures" = "futures 0.1.28 (registry+https://github.com/rust-lang/crates.io-index)";
          "hyper" = "hyper 0.12.33 (registry+https://github.com/rust-lang/crates.io-index)";
    ...
    "native-tls 0.2.3 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          ...
          "log" = {
            packageId = "log 0.4.7 (registry+https://github.com/rust-lang/crates.io-index)";
            target = (!((target."os" == "windows") || (target."os" == "macos") || (target."os" == "ios")));
          };
          "openssl" = {
            packageId = "openssl 0.10.23 (registry+https://github.com/rust-lang/crates.io-index)";
            target = (!((target."os" == "windows") || (target."os" == "macos") || (target."os" == "ios")));
          };
          "openssl-probe" = {
    ...
    "openssl 0.10.23 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          ...
          "lazy_static" = "lazy_static 1.3.0 (registry+https://github.com/rust-lang/crates.io-index)";
          "libc" = "libc 0.2.60 (registry+https://github.com/rust-lang/crates.io-index)";
          "openssl-sys" = "openssl-sys 0.9.47 (registry+https://github.com/rust-lang/crates.io-index)";
        };
        features = {
    ...
    "prettytable-rs 0.8.0 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          ...
          "encode_unicode" = "encode_unicode 0.3.5 (registry+https://github.com/rust-lang/crates.io-index)";
          "lazy_static" = "lazy_static 1.3.0 (registry+https://github.com/rust-lang/crates.io-index)";
    ...
    "regex 1.1.9 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          "aho-corasick" = "aho-corasick 0.7.4 (registry+https://github.com/rust-lang/crates.io-index)";
          "memchr" = "memchr 2.2.1 (registry+https://github.com/rust-lang/crates.io-index)";
          "regex-syntax" = "regex-syntax 0.6.8 (registry+https://github.com/rust-lang/crates.io-index)";
    ...
    "serde 1.0.97 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        version = "1.0.97";
        edition = "2015";
        sha256 = "08wviyfq7n38afpd1x1yl5yrh7gfbl1jhrryxjd6xhsy0cfs3wrr";
        authors = [
        ...
        dependencies = {
          "serde_derive" = {
            packageId = "serde_derive 1.0.97 (registry+https://github.com/rust-lang/crates.io-index)";
            optional = true;
          };
        };
        features = {
    ...
    "serde_derive 1.0.97 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        version = "1.0.97";
        edition = "2015";
        sha256 = "1rikzyq1h069bp2crx0v175asn4n7bcmdh3zczbb1barm280cjnp";
        procMacro = true;
        authors = [
          "Erick Tryzelaar <erick.tryzelaar@gmail.com>"
          "David Tolnay <dtolnay@gmail.com>"
    ...
    "winapi 0.3.7 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "sysinfoapi" "timezoneapi" "utilapiset" "winbase" "wincon" "wincrypt" "windef" "winerror" "winnls" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
    ...
    "winconsole 0.10.0 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          ...
          "lazy_static" = "lazy_static 1.3.0 (registry+https://github.com/rust-lang/crates.io-index)";
          "rgb" = "rgb 0.8.13 (registry+https://github.com/rust-lang/crates.io-index)";
          "winapi" = {
            packageId = "winapi 0.3.7 (registry+https://github.com/rust-lang/crates.io-index)";
